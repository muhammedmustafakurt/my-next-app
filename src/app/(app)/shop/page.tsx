...
export default function Home() {
  return (
        ...
        <div className="swiper-wrapper">
          <div className="intro11-section swiper-slide slide-1 slide-bg-1 bg-position">
            ...
            <div className="intro11-content text-left">
              ...
              <p className="desc-content">
                ...
                fierent ullamcorper ius no, nec ea quodsi invenire.{" "}
              </p>
              <a
          ...
          <div className="intro11-section swiper-slide slide-2 slide-bg-1 bg-position">
            ...
            <div className="intro11-content text-left">
              ...
              <h2 className="title">
                Flowers and Candle <br /> Birthday Gift
              </h2>
              <p className="desc-content">
                Lorem ipsum dolor sit amet, pri autem nemore bonorum te. Autem
                fierent ullamcorper ius no, nec ea quodsi invenire.{" "}
        ...
        <div className="row">
          <div className="cat-1 col-md-4 col-sm-12 col-custom">
            <div className="categories-img mb-30">
              <a href="#">
                <img src="assets/images/category/home1-category-1.jpg" alt="" />
              </a>
        ...
        <div className="row">
          ...
          <div className="col-12 col-custom">
            <div className="section-title text-center mb-30">
              <span className="section-title-1">Wonderful gift</span>
          ...
          <div className="col-lg-8 ms-auto me-auto">
            <div className="history-area-content pb-0 mb-0 border-0 text-center">
              ...
              <p>
                ...
                dynamicus. Phasellus eu rhoncus dolor, vitae scelerisque sapien
              </p>
            </div>
          </div>
        </div>
              ...
              <div className="newsletter-form-wrap text-center">
                <form id="mc-form" className="mc-form">
                  <input
                    ...
                    name="EMAIL"
                  />
                  <button id="mc-submit" className="btn rounded-0" type="submit">
                    Subscribe
                  </button>
                </form>
              ...
              <div className="single-blog">
                ...
                <div className="blog-content">
                  <div className="blog-text">
                    ...
                    <p>
                      Lorem ipsu dolor sit amet cons elits cumque adipisicing, sed
                      do incid eiusmod tempor ut labore et dolore eveniet .
                    </p>
            ...
            <div className="blog-lst">
              <div className="single-blog">
                ...
                <div className="blog-content">
                  <div className="blog-text">
                    <h4>
                      <a href="blog-details-fullwidth.html">New Collection Two</a>
                    </h4>
                    <div className="blog-post-info">
                      <span>
                        <a href="#">By admin</a>
    ...
    <Script src="/assets/js/plugins/swiper-bundle.min.js" strategy="lazyOnload" />
      ...
      <Script src="/assets/js/plugins/jquery.ajaxchimp.min.js" strategy="lazyOnload" />
      <Script src="/assets/js/plugins/jquery-ui.min.js" strategy="lazyOnload" />
      <Script src="/assets/js/plugins/jquery.countdown.min.js" strategy="lazyOnload" />
